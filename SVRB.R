...
###################################
# SVRB model: protection is lost over time
# but may be refreshed by a booster

SVRB_mod <- function(t, y, parms) {
...
# 
# title(main=paste("SVRB model - boosting possible after:",round((parms["iB"]+1)/(parms["gamma"]+parms["nu"]),1),"years\ntime until protection loss:",m_dur,"±",sqrt(var_dur),"years"))
